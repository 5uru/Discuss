...
import torchaudio
import librosa
from backend.app.melo.text import cleaned_text_to_sequence, get_bert
from backend.app.melo.text.cleaner import clean_text
...
def get_hparams(init=True):
    ...
    parser.add_argument(
        "--pretrain_dur", type=str, default=None, help="pretrain model duration"
    )
